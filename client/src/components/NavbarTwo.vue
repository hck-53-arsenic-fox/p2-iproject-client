...
export default {
    name: 'NavbarTwo',
    methods: {
        ...mapActions(usePlayerStore, ['fetchUserProfile', 'logout', 'loginNavbar']),
        whatStatus() {
...
<template>
    <header class="site-navbar py-3  js-sticky-header site-navbar-target" style="background-color: black;"
        role="banner">
                    ...
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <li><a @click.prevent="$router.push('/users/' + userProfile.username + '/following')"
                                    class="nav-link" style="cursor: pointer;">Following</a></li>
