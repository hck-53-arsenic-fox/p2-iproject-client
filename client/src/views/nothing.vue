...
<template>
    ...
    <div class="text">
      ...
      <h2>Couldn't launch :(</h2>
         <h3 v-if="!acces_token">Page Not Found - lets take you <RouterLink to="/login" href="https://twitter.com/namratapdr">BACK</RouterLink></h3> 
         <h3 v-if="acces_token">Page Not Found - lets take you <RouterLink to="/" href="https://twitter.com/namratapdr">BACK</RouterLink></h3> 
    </div>
</body>
